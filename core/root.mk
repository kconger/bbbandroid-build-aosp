...
ifeq ($(strip $(kernel_not_configured)),)
	...
	$(MAKE) -C backports-3.18.1-1 ARCH=arm CROSS_COMPILE=$(CC_PREFIX) KLIB_BUILD=../kernel

kernel_clean:
	$(MAKE) -C kernel ARCH=arm  distclean
	$(MAKE) -C backports-3.18.1-1 ARCH=arm distclean
...
fs_tarball: $(FS_GET_STATS)
	...
	$(MAKE) -C backports-3.18.1-1 ARCH=arm CROSS_COMPILE=$(CC_PREFIX) KLIB_BUILD=../kernel INSTALL_MOD_PATH=$(ANDROID_FS_DIR)/system/vendor modules_install
